...
def count_spaces_and_commas_in_string(string, words_pattern, characters_pattern):

    characters_pattern_validator = '[,\s]+'
    ...
    if not characters_pattern is characters_pattern_validator:
        raise ValueError("We should be looking for commas and spaces only!")
    return [x, y]


try:
    print(count_spaces_and_commas_in_string(
